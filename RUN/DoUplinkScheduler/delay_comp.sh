...
grep "RX "$7   results/$TOTALNAME  | grep "D" | awk '{print $14}'  > tmp
...
./Graph1.sh $7_$8  results/MT_Y1_$8_$7.dat results/FME_Y1_$8_$7.dat results/RR_Y1_$8_$7.dat $7-Delay Users Delay[Sec]
