...
grep "power"  results/$TOTALNAME  | awk '{print $2}'    > tmp
	./compute_power.sh tmp  >> temporal
	rm tmp
	 let COUNT=COUNT+1
	done
...
./Graph1.sh $7_$8  results/MT_Y1_$8_$7.dat results/FME_Y1_$8_$7.dat results/RR_Y1_$8_$7.dat $7-Power Users power[dBm]

rm results/MT_Y1_$8_$7.dat 
rm results/FME_Y1_$8_$7.dat 
rm results/RR_Y1_$8_$7.dat 

echo  Power $7 REPORT FINISHED!! 
