...
until [ $NBUE -gt $2 ]; do
	...
	TOTALNAME=$FILE"_"$COUNT"_"$FILENAME"_MT_"$NBUE"U"$CELS"C"".sim"
		...
		grep "RX "$7   results/$TOTALNAME  | awk '{print $8+5}'  > tmp
...
./Graph1.sh $7_$8  results/MT_Y1_$8_$7.dat results/FME_Y1_$8_$7.dat results/RR_Y1_$8_$7.dat $7-Throughput Users Throughput[bps]
